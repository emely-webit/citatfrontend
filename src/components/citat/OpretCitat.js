    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <textarea name="katId" rows="3" defaultValue="5e4a61d8b4ee133528713fd2" onChange={(e) => setOpCitat({...opCitat, kategoriId: e.target.value})} className="form-control" placeholder="Citatets tekst....." ></textarea>
                </div>
